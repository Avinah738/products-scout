...
const RegistrationPage = () => {
    ...
    const API_BASE_URL = 'https://productsscout.com/api';
    ...
    const handleSubmitEmail = async (e) => {
        ...
        setLoading(true);
        try {
            await axios.post(`${API_BASE_URL}check-user/`, { email: formData.email });
                    ...
                    <div className="terms-modal-content" id="terms-modal-content">
                        ...
                        <div className="terms-content" id="terms-content">
                            ...
                            <ul id="terms-contact-list">
                                <li id="terms-contact-email">Email: <a href="mailto:privacy@productsscout.com"
                                              className="help-link">privacy@productsscout.com</a></li>
